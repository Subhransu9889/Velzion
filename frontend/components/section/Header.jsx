...
import { Home, Search, Monitor, Package, User, Video, Smartphone, Crown } from "lucide-react";
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
export default function Header() {
  ...
  const menuItems = [
    ...
    { id: "movies", icon: Package, label: "Movies" },
    { id: "sports", icon: RunningIcon, label: "Sports" },
  ...
  return (
    <div className="fixed left-0 top-12 flex flex-col h-screen w-16 md:w-16 sm:w-12 bg-black items-center py-2 z-50">
      ...
      <div className="mb-12 transition-transform duration-300 hover:scale-110 cursor-pointer mt-16 sm:mt-12">
        <Crown className="w-8 h-8 sm:w-6 sm:h-6 text-[#FFD700]" />
      </div>
