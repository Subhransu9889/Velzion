...
export default async function JioPlusPage() {
    ...
    return (
        <main className="h-screen mt-2 p-8">
            <h1 className="text-2xl font-bold mb-6 bg-gradient-to-r text-transparent from-white to-pink-700 bg-clip-text">Velzion+ Premium Videos</h1>
            {/*<ul*/}
            ...
            {/*        <Link*/}
            {/*            key={index}*/}
            {/*            href={`velzion+/watch?id=${video.id}`}*/}
