...
function Subscription() {
    ...
    const handlePaymentClick = async () => {
        ...
        try {
            ...
            const options = {
                ...
                currency: "INR",
                name: "Velzion Corp",
                description: "Test Velzion Transaction",
    ...
    return (
        <div className="min-h-screen mt-[74px] w-[95%]">
            <Image
                src="/Subscription_Back_ground.png"
            ...
            <div className="mx-auto p-4 md:pt-8 pt-4">
                ...
                <div className="md:mx-16">
                    ...
                    <button
                        className="bg-pink-600 p-3 md:mt-10 item-start flex font-medium rounded-lg ml-2 hover: cursor-pointer hover:scale-110 duration-300"
